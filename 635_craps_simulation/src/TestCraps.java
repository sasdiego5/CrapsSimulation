...
public class TestCraps
{
	...
	public TestCraps()
	{
		...
		//use crooked die to play
		//game = new CrapsGame(new CrookedDie1(), new CrookedDie1()); // win all the games
		//game = new CrapsGame(new CrookedDie1(), new CrookedDie2()); // win no games
